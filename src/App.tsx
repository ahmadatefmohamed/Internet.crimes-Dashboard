          ...
          <div className="flex items-center gap-2 md:gap-3 flex-wrap justify-center">
            ...
            <div className="relative" onClick={(e) => e.stopPropagation()}>
              <button
                ...
                className="p-2.5 bg-white rounded-xl hover:bg-neutral-50 transition-colors cursor-pointer text-[#171717] flex items-center justify-center h-10 w-10 md:h-[42px] md:w-[42px] shrink-0 shadow-sm"
                title="طباعة التقرير"
              >
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
                  ...
                  <div className="relative w-full sm:w-auto" id="filter-months-dropdown-container">
                    <button
                      ...
                      className="flex items-center justify-between sm:justify-start gap-2 text-xs font-bold px-3.5 py-2.5 border border-[#ECEEF2] rounded-xl bg-white hover:bg-neutral-50 transition-colors shadow-sm cursor-pointer text-neutral-700 w-full sm:min-w-36 select-none"
                    >
                      <div className="flex items-center gap-2">
                  ...
                  <div className="relative w-full sm:w-auto" id="filter-aspects-dropdown-container">
                    <button
                      ...
                      className="flex items-center justify-between sm:justify-start gap-2 text-xs font-bold px-3.5 py-2.5 border border-[#ECEEF2] rounded-xl bg-white hover:bg-neutral-50 transition-colors shadow-sm cursor-pointer text-neutral-700 w-full sm:min-w-40 select-none"
                    >
                      <div className="flex items-center gap-2">
